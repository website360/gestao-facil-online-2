...
CREATE POLICY IF NOT EXISTS "Anon clients can create their own budgets"
ON public.budgets
FOR INSERT
TO anon
WITH CHECK (
...
CREATE POLICY IF NOT EXISTS "Anon clients can view their own budgets"
ON public.budgets
FOR SELECT
TO anon
USING (
...
CREATE POLICY IF NOT EXISTS "Anon clients can update their own budgets"
ON public.budgets
FOR UPDATE
TO anon
USING (
